...
publishing {
    repositories {
        ...
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/viral32111/library")
    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("Library")
                description.set("Shared code for my Minecraft mods.")
                url.set("https://github.com/viral32111/library")

                licenses {
                    license {
                        name.set("GNU Affero General Public License v3.0")
                        url.set("https://github.com/viral32111/library/blob/main/LICENSE.txt")
                    }
                }
                ...
                scm {
                    connection.set("scm:git:git://github.com/viral32111/library.git")
                    developerConnection.set("scm:git:git://github.com/viral32111/library.git")
                    url.set("https://github.com/viral32111/library")
                }
            }
